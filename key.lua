--==================================================--
-- RSQ KEY SYSTEM — FULL PASTEBIN API INTEGRATION
--==================================================--
...
local PASTEBIN_RAW_URL = "https://pastebin.com/raw/sRi0k7x0"
...
local function validate(keyToVerify, skipFetch)
    ...
    if data.notifications and data.notifications[USER_NAME] then
        ...
        if n.time > LastNotifTime then
            ...
            elseif n.type == "KEY_ADDED" then createNotify("✅ New key added for you!", Color3.fromRGB(50, 255, 50))
            end
        end
    end
...
task.spawn(function()
    ...
    if success then
        ...
        if IsAdmin then
            createNotify("👑 Admin privileges detected", Color3.fromRGB(255, 204, 0))
        end
    else
